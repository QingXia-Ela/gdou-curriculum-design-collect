...
//lpm_counter DEVICE_FAMILY="Cyclone II" lpm_direction="UP" lpm_modulus=2500000 lpm_port_updown="PORT_UNUSED" lpm_width=31 clk_en clock q sclr
...
`endif
	...
	assign
		...
		data = {31{1'b0}},
		external_cin = 1'b1,
		modulus_bus = 31'b0000000001001100010010110011111,
